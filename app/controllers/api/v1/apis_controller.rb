class Api::V1::ApisController < ApplicationController
  ...
  def set_application
    ...
    render json: { errors: 'Application not found' }, status: :not_found unless @current_application
  end
  ...
  def set_chat
    ...
    render json: { errors: 'Chat not found' }, status: :not_found unless @current_chat
  end
  ...
  def set_message
    ...
    render json: { errors: 'Message not found' }, status: :not_found unless @current_message
  end
